...
function(buzz_make _SCRIPT)
  ...
  # Make _BYTECODE, _BASM and _DEBUG names with .bo, .basm, and .bdb instead of .bzz
  ...
  set(_buzz_make_BASM "${_buzz_make_FNAME}.basm")
  ...
  if(NOT "${_buzz_make_DIR}" STREQUAL "")
    ...
    set(_buzz_make_BASM "${_buzz_make_DIR}${_buzz_make_BASM}")
  ...
  if(NOT "${BUZZ_BZZ_INCLUDE_DIR}" STREQUAL "")
    set(_buzz_make_BUZZ_INCLUDE_PATH "${_buzz_make_BUZZ_INCLUDE_PATH}" "${BUZZ_BZZ_INCLUDE_DIR}")
  endif(NOT "${BUZZ_BZZ_INCLUDE_DIR}" STREQUAL "")
